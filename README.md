...
[AppVeyor CI build](https://ci.appveyor.com/project/rexcfnghk/marksix-parser) and [Travis CI build](https://travis-ci.org/rexcfnghk/marksix-parser) will also trigger OpenCover test coverage being sent to [Coveralls](https://coveralls.io/github/rexcfnghk/marksix-parser)
